...
var input = getInput(inputFile: "input7pt2a", extension: "txt")
//print(input)
...
let amplifiedOutput = phaseSettingsFeedback.map { amplifier(originalProgram: program, phases: $0) }

print(amplifiedOutput)
